import warnings
from kernel.simulation import TraCISimulation
from kernel.network import TraCIKernelNetwork
from kernel.vehicle import TraCIVehicle
from kernel.traffic_light import TraCITrafficLight
...
Kernel(simulator='traci',sim_params=sim_params)