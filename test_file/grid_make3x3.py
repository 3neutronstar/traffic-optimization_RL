...
class Network():
    ...
    def generate_nod_xml(self):
        ...
        tree.write(self.xml_nod_pos+'.xml', pretty_print=True,
    ...
    def generate_net_xml(self):
        os.system('netconvert --node-files={}.nod.xml --edge-files={}.edg.xml --output-file={}.net.xml'.format(
    ...
    def sumogui(self):
        os.system('sumo-gui -c {}.sumocfg'.format(self.current_path +
